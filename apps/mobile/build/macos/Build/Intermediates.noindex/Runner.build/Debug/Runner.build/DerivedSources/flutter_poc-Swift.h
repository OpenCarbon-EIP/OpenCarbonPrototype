...
#ifndef FLUTTER_POC_SWIFT_H
#define FLUTTER_POC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_poc",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC11flutter_poc11AppDelegate")
...
SWIFT_CLASS("_TtC11flutter_poc17MainFlutterWindow")
